...
node {
    ...
    def runOne = { String sid ->
        build job: "services/${sid}", wait: true, propagate: true, parameters: [
            ...
            string(name: "KUBECONFIG_CREDENTIALS_ID", value: (params.KUBECONFIG_CREDENTIALS_ID ?: "kubeconfig").toString()),
            string(name: "KUBE_CONTEXT", value: (params.KUBE_CONTEXT ?: "kubernetes-admin@kubernetes").toString()),
            string(name: "KUBE_NAMESPACE", value: (params.KUBE_NAMESPACE ?: "smart-freelance-dev").toString()),
